...
Z3 can be installed with pypi using the [[./requirements.txt]] file, while Boogie can be installed by using the [[https://dotnet.microsoft.com/en-us/download/dotnet/6.0][.NET SDK 6]] and issuing the following command:
#+begin_src sh
