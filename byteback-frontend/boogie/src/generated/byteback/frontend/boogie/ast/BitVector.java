 ...
 * @astdecl BitVector : Type ::= <Size:Integer>;
 * @production BitVector : {@link Type} ::= <span class="component">&lt;Size:Integer&gt;</span>;

 */
public class BitVector extends Type implements Cloneable {
  /**
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenInteger_Size == ((BitVector) node).tokenInteger_Size);    
  }
  /**
