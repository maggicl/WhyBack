...
/**
 * @ast node
 * @declaredat /home/mpaganoni/Projects/byteback/byteback-frontend/boogie/spec/Boogie.ast:161
 * @astdecl GotoStatement : Statement ::= [Label:Identifier];
 * @production GotoStatement : {@link Statement} ::= <span class="component">[Label:{@link Identifier}]</span>;

 */
public class GotoStatement extends Statement implements Cloneable {
  /**
  ...
  public GotoStatement(Opt<Identifier> p0) {
    setChild(p0, 0);
  }
  /** @apilevel low-level 
   ...
   */
  public GotoStatement clone() throws CloneNotSupportedException {
    GotoStatement node = (GotoStatement) super.clone();
    return node;
  }
  /** @apilevel internal 
  ...
  public GotoStatement copy() {
    try {
      GotoStatement node = (GotoStatement) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public GotoStatement treeCopyNoTransform() {
    GotoStatement tree = (GotoStatement) copy();
    if (children != null) {
