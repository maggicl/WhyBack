...
/**
 * @ast node
 * @declaredat /home/mpaganoni/Projects/byteback/byteback-frontend/boogie/spec/Boogie.ast:83
...
public class LessThanEqualsOperation extends BinaryExpression implements Cloneable {
  ...
  public LessThanEqualsOperation(Expression p0, Expression p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /** @apilevel low-level 
   ...
   */
  public LessThanEqualsOperation clone() throws CloneNotSupportedException {
    LessThanEqualsOperation node = (LessThanEqualsOperation) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:46
   */
  public LessThanEqualsOperation copy() {
    try {
      LessThanEqualsOperation node = (LessThanEqualsOperation) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  @Deprecated
  public LessThanEqualsOperation fullCopy() {
   ...
   */
  public LessThanEqualsOperation treeCopyNoTransform() {
    LessThanEqualsOperation tree = (LessThanEqualsOperation) copy();
    if (children != null) {
   ...
   */
  public LessThanEqualsOperation treeCopy() {
    LessThanEqualsOperation tree = (LessThanEqualsOperation) copy();
    if (children != null) {
      for (int i = 0; i < children.length; ++i) {
