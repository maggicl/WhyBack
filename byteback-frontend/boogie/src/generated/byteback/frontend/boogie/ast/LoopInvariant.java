 ...
 */
public class LoopInvariant extends ASTNode<ASTNode> implements Cloneable {
  /**
  ...
  public LoopInvariant(Expression p0) {
    setChild(p0, 0);
  }
  /** @apilevel low-level 
   ...
   */
  public LoopInvariant clone() throws CloneNotSupportedException {
    LoopInvariant node = (LoopInvariant) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:45
   */
  public LoopInvariant copy() {
    try {
      LoopInvariant node = (LoopInvariant) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public LoopInvariant treeCopyNoTransform() {
    LoopInvariant tree = (LoopInvariant) copy();
    if (children != null) {
