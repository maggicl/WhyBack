 ...
 */
public class NumberLiteral extends Literal implements Cloneable {
  /**
  ...
  public NumberLiteral(Integer p0) {
    setValue(p0);
  }
  /** @apilevel low-level 
   ...
   */
  public NumberLiteral clone() throws CloneNotSupportedException {
    NumberLiteral node = (NumberLiteral) super.clone();
    return node;
  }
  /** @apilevel internal 
  ...
  public NumberLiteral copy() {
    try {
      NumberLiteral node = (NumberLiteral) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public NumberLiteral treeCopyNoTransform() {
    NumberLiteral tree = (NumberLiteral) copy();
    if (children != null) {
  ...
  protected boolean is$Equal(ASTNode node) {
    return super.is$Equal(node) && (tokenInteger_Value == ((NumberLiteral) node).tokenInteger_Value);    
  }
  /**
