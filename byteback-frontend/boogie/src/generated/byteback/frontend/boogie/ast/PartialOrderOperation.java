 ...
 * @astdecl PartialOrderOperation : RelationalExpression ::= LeftOperand:Expression RightOperand:Expression;
 * @production PartialOrderOperation : {@link RelationalExpression};

 */
public class PartialOrderOperation extends RelationalExpression implements Cloneable {
  /**
