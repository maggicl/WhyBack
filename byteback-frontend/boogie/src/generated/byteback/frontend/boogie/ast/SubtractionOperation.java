...
public class SubtractionOperation extends BinaryExpression implements Cloneable {
  ...
  public SubtractionOperation(Expression p0, Expression p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /** @apilevel low-level 
   ...
   */
  public SubtractionOperation clone() throws CloneNotSupportedException {
    SubtractionOperation node = (SubtractionOperation) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:46
   */
  public SubtractionOperation copy() {
    try {
      SubtractionOperation node = (SubtractionOperation) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  @Deprecated
  public SubtractionOperation fullCopy() {
   ...
   */
  public SubtractionOperation treeCopyNoTransform() {
    SubtractionOperation tree = (SubtractionOperation) copy();
    if (children != null) {
   ...
   */
  public SubtractionOperation treeCopy() {
    SubtractionOperation tree = (SubtractionOperation) copy();
    if (children != null) {
      for (int i = 0; i < children.length; ++i) {
