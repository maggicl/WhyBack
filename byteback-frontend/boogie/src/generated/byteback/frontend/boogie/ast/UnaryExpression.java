 ...
 * @astdecl UnaryExpression : Expression ::= Operand:Expression;
...
public abstract class UnaryExpression extends Expression implements Cloneable {
   ...
   */
  @Deprecated
  public abstract UnaryExpression fullCopy();
  /**
   * Create a deep copy of the AST subtree at this node.
   * The copy is dangling, i.e. has no parent.
   * @return dangling copy of the subtree at this node
   ...
   */
  public abstract UnaryExpression treeCopyNoTransform();
  /**
   * Create a deep copy of the AST subtree at this node.
   ...
   */
  public abstract UnaryExpression treeCopy();
  /**
