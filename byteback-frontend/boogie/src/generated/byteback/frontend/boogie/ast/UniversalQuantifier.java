...
/**
 * @ast node
 * @declaredat /home/mpaganoni/Projects/byteback/byteback-frontend/boogie/spec/Boogie.ast:96
 * @astdecl UniversalQuantifier : QuantifierExpression ::= Operand:Expression TypeArguments:TypeArgument* Parameters:QuantifierArgument* Triggers:Expression*;
 * @production UniversalQuantifier : {@link QuantifierExpression};

 */
public class UniversalQuantifier extends QuantifierExpression implements Cloneable {
  /**
  ...
  public UniversalQuantifier(Expression p0, List<TypeArgument> p1, List<QuantifierArgument> p2, List<Expression> p3) {
    setChild(p0, 0);
    setChild(p1, 1);
    setChild(p2, 2);
    setChild(p3, 3);
   ...
   */
  public UniversalQuantifier clone() throws CloneNotSupportedException {
    UniversalQuantifier node = (UniversalQuantifier) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:51
   */
  public UniversalQuantifier copy() {
    try {
      UniversalQuantifier node = (UniversalQuantifier) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  @Deprecated
  public UniversalQuantifier fullCopy() {
   ...
   */
  public UniversalQuantifier treeCopyNoTransform() {
    UniversalQuantifier tree = (UniversalQuantifier) copy();
    if (children != null) {
   ...
   */
  public UniversalQuantifier treeCopy() {
    UniversalQuantifier tree = (UniversalQuantifier) copy();
    if (children != null) {
      for (int i = 0; i < children.length; ++i) {
