...
/**
 * @ast node
 * @declaredat /home/mpaganoni/Projects/byteback/byteback-frontend/boogie/spec/Boogie.ast:115
 * @astdecl UniversalQuantifier : QuantifierExpression ::= Operand:Expression TypeArguments:TypeArgument* Parameters:Binding* Triggers:Expression*;
...
public class UniversalQuantifier extends QuantifierExpression implements Cloneable {
  ...
  public UniversalQuantifier(Expression p0, List<TypeArgument> p1, List<Binding> p2, List<Expression> p3) {
    setChild(p0, 0);
    setChild(p1, 1);
    setChild(p2, 2);
    setChild(p3, 3);
