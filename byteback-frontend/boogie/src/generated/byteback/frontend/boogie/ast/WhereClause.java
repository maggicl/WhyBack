 ...
 */
public class WhereClause extends ASTNode<ASTNode> implements Cloneable {
  /**
  ...
  public WhereClause(Expression p0) {
    setChild(p0, 0);
  }
  /** @apilevel low-level 
   ...
   */
  public WhereClause clone() throws CloneNotSupportedException {
    WhereClause node = (WhereClause) super.clone();
    return node;
  }
  /** @apilevel internal 
   ...
   */
  public WhereClause treeCopyNoTransform() {
    WhereClause tree = (WhereClause) copy();
    if (children != null) {
